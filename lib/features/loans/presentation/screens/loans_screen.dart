...
class LoansScreen extends StatefulWidget {
  ...
  const LoansScreen({super.key, this.initialStatus});
...
class _LoansScreenState extends State<LoansScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(
        title: 'Préstamos & Cobranza',
        subtitle: 'Cartera PrestaRD',
                    ...
                    if (list.isEmpty)
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final int loanId = int.tryParse('${loan['id']}') ?? 0;
                          ...
                          final String freqLabel = freq == 'weekly' ? 'Semanal' : (freq == 'biweekly' ? 'Quincenal' : (freq == 'daily' ? 'Diario' : 'Mensual'));
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  // Direct Actions (Cobrar Cuota & Ver Cuotas)
                                  Row(
                                    children: [
                                      Expanded(
                                        child: ElevatedButton.icon(
                                          ...
                                          onPressed: () => context.go('/payment?loanId=$loanId'),
                                      ...
                                      Expanded(
                                        child: OutlinedButton.icon(
                                          ...
                                          onPressed: () => context.go('/loans/$loanId'),
